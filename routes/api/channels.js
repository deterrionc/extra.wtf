...
const getNewsVideos = async (videos, time) => {
  ...
  if (time === 'day') {
    ...
    const next_news_60 = await Category.findOne({ name: "next_news_60" }).populate("videos");
